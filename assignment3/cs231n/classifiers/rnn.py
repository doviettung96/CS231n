...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        if self.cell_type == 'rnn':
            h, hidden_cache = rnn_forward(x, h0, Wx, Wh, b) # N, T, H
        elif self.cell_type == 'lstm':
            h, hidden_cache = lstm_forward(x, h0, Wx, Wh, b) # N, T, H
        scores, affine_cache = temporal_affine_forward(h, W_vocab, b_vocab) # N, T, V
